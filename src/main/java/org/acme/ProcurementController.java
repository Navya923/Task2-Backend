...
public class ProcurementController {
    ...
    public List<Cart> getCarts(){
        System.out.println("fetching cart list for procurement");
    ...
    public Response approveCart( @PathParam("id") long id){
        ...
        cart.setStatus(Status.PROCUREMENT_APPROVAL);
        cart.persist();
    ...
    public Response rejectCart( @PathParam("id") long id){
        Cart cart = Cart.findById(id);
        cart.setStatus(Status.PROCUREMENT_REJECT);
        cart.persist();
        return Response.status(Response.Status.OK).build();
    }
    ...
    public List<Cart> GetApprovedCarts() {
        System.out.println("fetching approved cart list for procurement");
    ...
    public List<Cart> GetRejectedCarts() {
        System.out.println("fetching rejected cart list for procurement");
        List<Cart> carts = cartRepository.getCarts(Arrays.asList(Status.PROCUREMENT_REJECT));
        System.out.println(carts);
        return carts;
    }
